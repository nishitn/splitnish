...
class CategoryComposables {
    companion object {
        ...
        fun Update(
            ...
            Column {
                ...
                LazyColumn {
                    ...
                    item { SubCategoryEntitiesRow(selectedSubCategoryEntities, newSubCategoryEntities, onDelete) }
                }
                ButtonsRow(
        ...
        @Composable
        private fun UpdateSubCategoryEntityDialog(onCreate: (SubCategoryEntity) -> Unit, onDismiss: () -> Unit) {
