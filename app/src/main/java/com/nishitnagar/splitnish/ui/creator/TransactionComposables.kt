    ...
    companion object {
        ...
        private fun AmountRow(
            ...
            Row(
                ...
                Text(text = "Amount")
                CustomNumberTextField(value = transactionEntityState.value.amount, label = "", onValueChange = {
                    transactionEntityState.value = transactionEntityState.value.copy(amount = it.toDoubleOrNull())
                })
            }
        }
        ...
        private fun ButtonsRow(
            ...
            Row {
                Button(enabled = transactionEntityState.value.amount != null, onClick = {
                    if (isEntityProvided) onUpdate(transactionEntityState.value) else onCreate(transactionEntityState.value)
                    onDismiss()
                }) {
