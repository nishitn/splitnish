...
fun MainScreen(transactionViewModel: TransactionViewModel, userViewModel: UserViewModel) {
  ...
  val transactionEntities =
    transactionViewModel.transactionEntities.collectAsState(initial = listOf())
  ...
  Column {
    ...
    ControlShowDataComposable(visibilityState = accountEntitiesVisibilityState,
                              ...
                              onClick = {
                                ...
                                if (it != null) intent.putExtra(
                                  BundleKeys.ENTITY_ID.name,
                                  it.toString()
                                )
                                intent.putExtra(
                                  BundleKeys.INT_RESOURCE.name,
...
fun switch(visibilityState: MutableState<VisibilityState>) {
  visibilityState.value =
    if (visibilityState.value == VisibilityState.VISIBLE) VisibilityState.HIDDEN
